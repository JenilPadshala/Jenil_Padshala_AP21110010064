...
struct node
{
	int arrival; // time at which the process enters the ready queue
	int burst;	 // The total amount of time required by the CPU to execute the whole process
	int burst1;
	int turnaround; // the time taken by a process since it enters a ready queue for the process of execution till the completion
	int waiting;	// total time that a process spends while waiting in a ready queue until it gets the CPU
	int finish;
	int name;
...
int main()
{
	...
	cout << "******** Please select your choice ********" << endl
		 << endl;
	cout << "1.Processes with same arrival time 0" << endl
		 << endl;
	cout << "2.Processes with random arrival time" << endl
		 << endl;
